  ...
  return (
    <div className="h-screen bg-primary/60 relative w-screen flex flex-col items-center justify-center gap-2">
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:text-left h-full container mx-auto relative">
          <motion.h1
          ...
          className="w-full h-full max-w-[500px] max-h[400px] absolute -bottom-[22%] right-0 z-10"
        >
          <Avatar />
        </motion.div>
        </div>
